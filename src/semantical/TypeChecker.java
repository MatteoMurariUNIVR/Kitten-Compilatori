...
public class TypeChecker {
	...
	private final boolean assertPermitted;
	...
	private TypeChecker(Type returnType, Table<TypeAndNumber> env, int varNum, ErrorMsg errorMsg, boolean flagAssert) {
		this.returnType = returnType;
		this.env = env;
		this.varNum = varNum;
		this.errorMsg = errorMsg;
		this.assertPermitted=flagAssert;
	}
	...
	public TypeChecker(Type returnType, ErrorMsg errorMsg, boolean flagAssert) {
		this.returnType = returnType;
	...
	public boolean getAssertPermission()
	{
	...
	public TypeChecker putVar(String var, Type type) {
		...
		return new TypeChecker(returnType,
			env.put(var, new TypeAndNumber(type, varNum)), varNum + 1, errorMsg, assertPermitted);
	}
	...
	public String error(int pos)
	{
		return errorMsg.error(pos);
	}
